...
{
    /// <inheritdoc />
    public partial class AddPropertyTypesToProject : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlockingLogID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockingLogs", x => x.BlockingLogID);
                    table.ForeignKey(
                        name: "FK_BlockingLogs_Customers_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "Customers",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlockingLogs_Users_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockingLogs_CustomerID",
                table: "BlockingLogs",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_BlockingLogs_UserID",
                table: "BlockingLogs",
                column: "UserID");
